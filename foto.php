...
<main class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-2 text-white"><?= $_SESSION['namalengkap'] ?>'s gallery</h1>
    <hr class="text-white">
      ...
      <div class="col-sm-3 bg-transparent text-white">
        ...
        <form action="foto.php" method="POST" enctype="multipart/form-data">
          <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control rounded-pill" id="judulfoto" placeholder="Enter Picture Title" name="judulfoto">
          </div>
          <div class="mb-3">
            <label for="deskripsifoto">Description</label>
            <textarea name="deskripsifoto" id="deskripsifoto" class="form-control rounded-4" rows="5" placeholder="Enter picture Description"></textarea>
          </div>
          <div class="mb-3">
          ...
          <button type="submit" class="btn btn-primary rounded-pill" name="tambah">Add Picture</button>
        </form>
      </div>
      <div class="col-sm-9">
